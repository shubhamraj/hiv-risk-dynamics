...
public interface ParametersInterface {
	...
	/** */
	public static enum LineageEventType {Transmission, Exit}
	/** */
	...
	public static enum AHIKey {
		...
		OBID, Time, InfectorID, InfectorTick, InfectedID, ActType, TimeSinceLastInf, InfectorStageOfInfection, BranchLength,
		InfectorRiskState, InfectedRiskState, MixingSite
	};
	/** */
...
//	public static final String inputFile = "PartnershipModelParams.csv";
	...
	public static enum MixingSite {None, Common, HighRisk};
	/** Episodic risk model's states */
	public static enum RiskState {None, High, Low}
}
